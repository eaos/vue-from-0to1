...
module.exports = {
    ...
    entry:{
        ...
        test:[path.resolve(__dirname,'../arc/t.js'),path.resolve(__dirname,"../src/s.js"),path.resolve(__dirname, '../src/validform.js'),path.resolve(__dirname, '../src/assets/bootstrap/js/bootstrap.min.js')],
